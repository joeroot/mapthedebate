...
\setmonofont[Scale=0.855]{Consolas}
...
\newfontfamily\consolasfont[Scale=0.855]{Consolas}
...
\begin{document}
	...
	\include{retrieval/retrieval}

	\include{classifiers/classifiers}

	\include{subjectivity/subjectivity}
	
	\include{polarity/polarity}
	
	\include{emotion/emotion}
	
	\include{topic/topic}
	
	\include{delivery/delivery}

...
\begin{lstlisting}[language=Ruby, caption={Method for building a status's feature set, where \texttt{@features = [:feature\_1,..., :feature\_n]}}, label=classifiers:status_feature_set]
